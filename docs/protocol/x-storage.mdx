...
<img src={require('/img/AP_StorageCreditMechanism.png').default} alt="Storage credit flow" style={{maxWidth: '700px', borderRadius: '8px', margin: '2rem auto', display: 'block'}} /> 
